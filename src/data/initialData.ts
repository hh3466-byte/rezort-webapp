...
export const defaultSettings: ResortSettings = {
  ...
  maxCapacity: 12,
  defaultDailyRateBoarding: 130,
  defaultDailyRateTraining: 260,
  defaultDailyRateCombined: 340,
...
export const initialBookings: Booking[] = [
  ...
  },
  {
    ...
    stayStatus: 'checked_in',
    notes: 'תכנית אילוף משמעת מתקדמת + הליכה ברצועה',
    vaccinationValid: true,
  ...
  },
  {
    ...
    stayStatus: 'booked',
    notes: 'פנסיון + אילוף חיזוקים חיוביים',
    vaccinationValid: true,
