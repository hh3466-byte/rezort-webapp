    ...
    try {
      ...
      if (data) {
        const settingsData = data.data || {
          ...
          defaultDailyRateBoarding: data.default_daily_rate_boarding ?? data.defaultDailyRateBoarding,
          defaultDailyRateTraining: data.default_daily_rate_training ?? data.defaultDailyRateTraining,
          defaultDailyRateCombined: data.default_daily_rate_combined ?? data.defaultDailyRateCombined,
          defaultDailyRateDaycare: data.default_daily_rate_daycare ?? data.defaultDailyRateDaycare,
