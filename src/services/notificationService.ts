...
• אמצע שבוע (ראשון–חמישי): שעות פעילות ושירות לקוחות 09:00–19:00.
• כניסה בסופ״ש / ערב חג: עד שעה 14:00 בשישי / ערב חג.
• יציאה מסופ״ש / חג: ביום ראשון / למחרת החג בשעה 09:00 בלבד (אין שחרורים בשבת).
• שימו לב: מעבר לשעות הפעילות (לפני 09:00 ואחרי 19:00) וכן בסופי שבוע וחגים – אין שירות לקוחות. על הבעלים להתגבר ולהתאפק! בשעות אלו איננו עוסקים בהולכים על 2 ומטפלים אך ורק במי שיש לו 4 רגליים וזנב 🐾
