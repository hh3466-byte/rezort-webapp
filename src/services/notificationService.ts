...
• בשישי וערב חג: עד שעה 14:00 ובצאת השבת / החג משעה 09:00
• בשעות שאין שירות לקוחות, אנו לא עוסקים בהולכים על 2.
אנו מתמקדים אך ורק בטיפול וברווחה רק למי שיש לו 4 רגליים וזנב 🐾
לכן על הבעלים להתגבר ולהתאפק עד למחרת לצאת השבת / החג לשעה 09:00 שאז נחדש את שירות הלקוחות לבעלי הכלבים.
תודה על ההתחשבות.
