...
export function generateBookingConfirmationMessage(booking: Booking, settings: ResortSettings): string {
  ...
  msg += `• כניסה עד שעה 14:00 בשישי / ערב חג, והיציאה היא ביום ראשון / למחרת החג בשעה 09:30 (היציאה לא יכולה להיות ביום שבת).\n`;
  msg += `• בסוף שבוע אין שירות לקוחות, הצוות מתמקד בטיפול בכלבים בלבד. על הבעלים להתגבר ולהתאפק עד לחידוש שירות הלקוחות למחרת השבת / חג.\n`;
