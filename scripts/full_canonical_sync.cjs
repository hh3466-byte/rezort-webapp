...
const ledgerData = [
  ...
  // August 2026
  { ref: '171099384', paid: 2200, phone: '0549420995', email: 'areiffman@gmail.com', name: 'אשר ריפמן', date: '2026-08-09', month: 'אוגוסט', dog: 'ריפמן', service: 'boarding' },
  { ref: '507419993', paid: 180, phone: '0545949480', email: 'gafni_nava@hotmail.com', name: 'נאוה גפני', date: '2026-08-10', month: 'אוגוסט', dog: 'גפני', service: 'daycare' },
  { ref: '4788806274', paid: 900, phone: '0527204572', email: 'dinadarom@gmail.com', name: 'דינה דיין', date: '2026-08-10', month: 'אוגוסט', dog: 'דיין', service: 'boarding' },
  { ref: '507400049', paid: 200, phone: '0545670355', email: 'shekel.hadas@gmail.com', name: 'תיאן שקל', date: '2026-08-10', month: 'אוגוסט', dog: 'שקל', service: 'daycare' },
  { ref: '171140534', paid: 180, phone: '0523669361', email: 'daliamoskov@gmail.com', name: 'דליה מוסקוביץ', date: '2026-08-10', month: 'אוגוסט', dog: 'מוסקוביץ', service: 'daycare' },
  { ref: '507810263', paid: 1500, phone: '0556646093', email: 'yerusbikaya54@gmail.com', name: 'ירוס ביקאיה', date: '2026-08-11', month: 'אוגוסט', dog: "ג'וי (מקדמה)", service: 'boarding' },
  { ref: '507807309', paid: 1000, phone: '0556646093', email: 'yerusbikaya54@gmail.com', name: 'ירוס ביקאיה', date: '2026-08-11', month: 'אוגוסט', dog: "ג'וי (תשלום 2)", service: 'boarding' },
  { ref: '4792995703', paid: 1000, phone: '0556646093', email: 'yerusbikaya54@gmail.com', name: 'ירוס ביקאיה', date: '2026-08-11', month: 'אוגוסט', dog: "ג'וי (תשלום 3)", service: 'boarding' },
  { ref: '507806497', paid: 3000, phone: '0556646093', email: 'yerusbikaya54@gmail.com', name: 'ירוס ביקאיה', date: '2026-08-11', month: 'אוגוסט', dog: "ג'וי (תשלום 4)", service: 'boarding' },
  { ref: '508467767', paid: 180, phone: '0542211442', email: 'dalkaher@gmail.com', name: 'דוד אלקחר', date: '2026-08-13', month: 'אוגוסט', dog: 'אלקחר', service: 'daycare' },
  { ref: '508442380', paid: 540, phone: '0503166129', email: 'amir.lior@gmail.com', name: 'Lior Amir', date: '2026-08-13', month: 'אוגוסט', dog: 'אמיר', service: 'boarding' },
  { ref: '508390101', paid: 180, phone: '0524577752', email: 'ziviisme@gmail.com', name: 'זיו זיסו', date: '2026-08-13', month: 'אוגוסט', dog: 'זיסו (עסקה 1)', service: 'daycare' },
  { ref: '508388527', paid: 180, phone: '0524577752', email: 'ziviisme@gmail.com', name: 'זיו זיסו', date: '2026-08-13', month: 'אוגוסט', dog: 'זיסו (עסקה 2)', service: 'daycare' },
  { ref: '508629487', paid: 180, phone: '0507585533', email: 'mmalisinai30@gmail.com', name: 'מלי סיני', date: '2026-08-14', month: 'אוגוסט', dog: 'סיני', service: 'daycare' },
  { ref: '4810894878', paid: 1950, phone: '0546260997', email: 'idoshavit6@gmail.com', name: 'עידו שביט', date: '2026-08-17', month: 'אוגוסט', dog: 'שביט', service: 'boarding' },
  { ref: '171893936', paid: 1170, phone: '0523669361', email: 'daliamoskov@gmail.com', name: 'דליה מוסקוביץ', date: '2026-08-17', month: 'אוגוסט', dog: 'מוסקוביץ', service: 'boarding' },
  { ref: '509363691', paid: 2550, phone: '0527777787', email: 'navri38@gmail.com', name: 'אור נברי', date: '2026-08-17', month: 'אוגוסט', dog: 'נברי', service: 'boarding' },
  { ref: '171863155', paid: 360, phone: '0523752473', email: 'yardenwun@gmail.com', name: 'ירדן וונטש', date: '2026-08-17', month: 'אוגוסט', dog: 'וונטש', service: 'boarding' },
  { ref: '509681462', paid: 540, phone: '0526757615', email: 'yuvalashuri@gmail.com', name: 'יובל אשורי', date: '2026-08-18', month: 'אוגוסט', dog: 'אשורי', service: 'boarding' },
  { ref: '4813075012', paid: 1050, phone: '0507729993', email: 'alexeyboga@gmail.com', name: 'אלכס בוגטירב', date: '2026-08-18', month: 'אוגוסט', dog: 'בוגטירב', service: 'boarding' },
  { ref: '510238566', paid: 300, phone: '0504858039', email: 'lica.kovalenko1@gmail.com', name: 'ליקה קובלנקו', date: '2026-08-20', month: 'אוגוסט', dog: 'קובלנקו', service: 'daycare' },
  { ref: '510464035', paid: 1770, phone: '0542211442', email: 'dalkaher@gmail.com', name: 'דוד אלקחר', date: '2026-08-21', month: 'אוגוסט', dog: 'אלקחר', service: 'boarding' },
  { ref: '510793633', paid: 180, phone: '0547778221', email: 'aerangil@gmail.com', name: 'עירן אברהם גיל', date: '2026-08-23', month: 'אוגוסט', dog: 'גיל', service: 'daycare' },
  { ref: '510777745', paid: 1740, phone: '0524577752', email: 'ziviisme@gmail.com', name: 'זיו זיסו', date: '2026-08-23', month: 'אוגוסט', dog: 'זיסו', service: 'boarding' },
  { ref: '510771399', paid: 270, phone: '0502244873', email: '', name: 'אופיר נידרי', date: '2026-08-23', month: 'אוגוסט', dog: 'נידרי', service: 'daycare' },
  { ref: '172804032', paid: 540, phone: '0524399271', email: 'omerlotem12@gmail.com', name: 'עומר לוטם', date: '2026-08-27', month: 'אוגוסט', dog: 'לוטם', service: 'boarding' },
